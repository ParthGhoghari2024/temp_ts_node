...
exports.userAnswerReview = void 0;
const dbConnection_1 = __importDefault(require("../../config/dbConnection"));
const userAnswerReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
`;
    try {
        let [result] = yield dbConnection_1.default.query(query, userId);
        if (!result) {
...
exports.userAnswerReview = userAnswerReview;
